...
/*
Create any ajax request, passing an endpoint object with all the required data as well as a callback function
*/
...
function setupClearUiHandlers() {
    ...
    // clear customer form when reset button is clicked

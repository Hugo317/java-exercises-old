...
public class MagicLamp {
    ...
    public void recharge(Genie genie) {
        ...
        if(!genie.getClass().getSimpleName().equals("RecyclableDemon")){
            System.out.println("GET OUT OF HERE WITH THAT NASTY NON DEMON");
            return;
        }

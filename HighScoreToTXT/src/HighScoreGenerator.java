...
public class HighScoreGenerator {
    int highscore;
    FileReader fileReader;

    HighScoreGenerator() throws FileNotFoundException {
        ;
    }

    public void getNewHighScore(){
        highscore = (int)(Math.random()*1000000);
        System.out.println(highscore);
    }

   // public char[] highScoreToArray() throws IOException {}
